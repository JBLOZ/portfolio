...
\vspace{2pt}
\small Soy estudiante del grado de Ingeniería en Inteligencia Artificial en la Universidad de Alicante y actualmente me queda el último año por cursar. Estoy buscando una oportunidad de convenio de prácticas para poder empezar cuanto antes. Cuento con formación en Machine Learning, Deep Learning, Reinforcement Learning, Computer Vision, NLP y sistemas RAG, así como experiencia práctica en el desarrollo de videojuegos.
\vspace{6pt}
...
\begin{resumeSection}{Movilidad Internacional y Proyectos Clave}
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
  \resumeItem{Trabajo en mi TFG: un sistema RAG para un chatbot ayudante de abogado capaz de buscar relaciones entre casos y apoyar el caso del cliente con jurisprudencia adecuada, usando Airflow, Spark, MinIO y Qdrant.}\resumeItem{Desarrollé y documenté un \bluehref{https://github.com/JBLOZ/CNN-classification----geometric2d-and-cancer-dangerousness}{modelo ResNet-50} en MATLAB para la detección de cáncer de piel, alcanzando una precisión del 80\% para clasificaciones cancerosas y del 85\% para no cancerosas.}\resumeItem{Construí una \bluehref{https://github.com/JBLOZ/py-ecommerce-software-proyect}{aplicación web de comercio electrónico inteligente} que permite la búsqueda de productos por texto o imagen a través de modelos de IA preentrenados.}\resumeItem{Creé un \bluehref{https://github.com/JBLOZ/heart-attack-fuzzy-system}{sistema experto difuso} para estimar el riesgo de ataque cardíaco basado en preguntas clínicas estructuradas.}\resumeItem{Diseñé un \bluehref{https://jbloz.github.io/portfolio/proyectos/PACMAN-CNN-Alphabeta/memoria.pdf}{agente de Pacman} que combina una CNN con heurísticas Alfa-Beta para un juego estratégico.}\resumeItem{Desarrollé y evalué un sistema de clasificación multiclase de animales, comparando el rendimiento de clasificadores como Bayes Gaussiano, ventanas de Parzen y variantes de k-NN en un \bluehref{https://jbloz.github.io/portfolio/proyectos/aprendizaje_automatico/p_02/memoria.pdf}{conjunto de datos balanceado del Zoo con 7 especies}.}\resumeItem{Implementé en AWS un \bluehref{https://jbloz.github.io/portfolio/proyectos/aws/p_03/memoria_03.pdf}{despliegue híbrido seguro} y una \bluehref{https://jbloz.github.io/portfolio/proyectos/aws/p_04/memoria_04.pdf}{estrategia canary} escalable con contenedores.}\resumeItem{Más proyectos en mi \bluehref{https://jbloz.github.io/portfolio}{portfolio}.}
      \resumeItemListEnd
...
\begin{resumeSection}{Educación}
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      {\textbf{Certificaciones AWS} $|$ \bluehref{https://www.credly.com/badges/f519a2a5-7413-469f-9060-bf23f53ecf9c/public_url}{Cloud Data Pipeline Builder}, \bluehref{https://www.credly.com/badges/85e5e8d7-8051-4503-96ee-250c99cd4b6e/public_url}{Machine Learning Foundations}}{2025}
    \resumeSubheading
...
\begin{resumeSection}{Habilidades Adicionales}
  \resumeSubHeadingListStart
    \item[]\small
      	\textbf{Herramientas:} AWS, LaTeX, Git, Docker, Bash, Airflow, Spark, MinIO \\
      	\textbf{Herramientas de Machine Learning:} PyTorch, Sklearn, Hugging Face, pandas, numpy, matplotlib, n8n, RAG, Qdrant \\
