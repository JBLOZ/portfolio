...
\begin{resumeSection}{Movilidad Internacional y Proyectos Clave}
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
  \resumeItem{Desarrollé un \bluehref{https://github.com/JBLOZ/fiat_depreciacion}{proyecto} con un datalake y una base de datos OLAP en MySQL con ETLs en Pentaho/Python para analizar la depreciación del euro y del poder adquisitivo de los españoles entre (2010--2025).}
