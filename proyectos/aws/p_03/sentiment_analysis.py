...
class SentimentAnalysisSpanish:
    def __init__(self):
        self.vectorizer = decompress_pickle(str('saved_model/ngram_vectorized_compressed.pbz2'))
        self.classifier = decompress_pickle(str('saved_model/classifier_naive_bayes_compressed.pbz2'))
